...
const copy: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'alm.change': '24H \u53d8\u52a8',
    'cmp.title': '\u6821\u91cf',
    'cmp.subline': '\u7528\u5386\u53f2\u5f00\u5e74\u6570\u636e\u751f\u6210 AUGAR \u516d\u5f15\u64ce\u7efc\u5408\u5206\uff0c\u5bf9\u7167 CLSA \u98ce\u6c34\u6307\u6570\u4e0e\u6052\u751f\u6307\u6570\u5b9e\u9645\u8d70\u52bf\u3002',
    'cmp.loading': '\u6b63\u5728\u8bfb\u53d6\u5bf9\u7167\u6570\u636e...',
    'cmp.price': '\u4ef7\u683c',
    'cmp.snapshot': '\u5e74\u5ea6\u5feb\u7167',
    'cmp.bias': '\u5e74\u5ea6\u503e\u5411',
    'cmp.confidence': '\u7f6e\u4fe1\u5ea6',
    ...
    'cmp.actual': '\u5b9e\u9645\u6536\u76ca',
    'oracle.title': '\u51b3\u7591',
    'oracle.subline': '\u4e00\u95ee\u4e00\u4e8b\uff0c\u4e00\u5366\u4e00\u7b54\u3002\u5148\u53d6\u540d\uff0c\u518d\u53d1\u95ee\u3002',
    'oracle.titleLabel': 'TITLE',
    'oracle.titlePlaceholder': '',
    'oracle.questionLabel': 'QUESTION',
    'oracle.questionPlaceholder': '\u4f8b\u5982\uff1a\u8fd9\u4e2a\u9879\u76ee\u672c\u6708\u662f\u5426\u5e94\u8be5\u7ee7\u7eed\u63a8\u8fdb\uff1f',
    'oracle.submit': '\u53d1\u95ee',
    'oracle.asking': '\u63a8\u6f14\u4e2d...',
    'oracle.failed': '\u95ee\u5366\u5931\u8d25',
    'oracle.historyEmpty': '\u6682\u65e0\u5386\u53f2\u8bb0\u5f55\u3002\u4e0b\u4e00\u6b21\u53d1\u95ee\u540e\u4f1a\u663e\u793a\u5728\u8fd9\u91cc\u3002',
    'reading.back': '\u8fd4\u56de\u95ee\u5366',
    ...
    'reading.compositeLead': '\u516d\u4e64\u65e2\u6210\uff0c\u5929\u673a\u6e10\u663e\u3002\u8c61\u5448',
    'reading.compositeMiddle': '\uff0c\u6c14\u8574',
  ...
  en: {
    ...
    'cmp.subline': 'A six-engine AUGAR composite generated at each historical year-start, compared with CLSA Feng Shui Index and actual Hang Seng price action.',
    'cmp.loading': 'Loading comparison data...',
    'cmp.price': 'Price',
    'cmp.snapshot': 'Annual Snapshot',
    'cmp.bias': 'Annual bias',
    'cmp.confidence': 'Confidence',
    'cmp.asOf': 'Price as of',
    'cmp.latest': 'Latest actual point',
    'cmp.period': 'Period',
    'cmp.actual': 'Actual return',
    'oracle.title': 'Oracle',
    'oracle.subline': 'One question at a time. The oracle answers with a single focused card \u2014 give your inquiry a name first.',
    'oracle.titleLabel': 'TITLE',
    'oracle.titlePlaceholder': '',
    'oracle.questionLabel': 'QUESTION',
    'oracle.questionPlaceholder': 'Example: Should this project continue this month?',
    'oracle.submit': 'Ask',
    'oracle.asking': 'Casting...',
    'oracle.failed': 'Oracle request failed',
    'oracle.historyEmpty': 'No question history yet. New readings will appear here.',
